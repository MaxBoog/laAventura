...
<head>
	...
	<title>Carlitos Adventures</title>

	<meta charset="utf-8" />
	<meta http-equiv="X-UA-Compatible" content="IE=edge" />
	<meta name="viewport" content="width=device-width, initial-scale=1" />
	<meta name="description" content="Carlitos Adventures organises tours in and around Medellín." />
	<meta name="keywords" content="Carlitos Adventures,tours,activities,Medellín,colombia" />
...
<body>
	...
	<section class="container">
		<div class="row">
			<h1 class="mx-auto header-text">Tours</h1>
		</div>
		<hr>
	</section>
	...
	<section class="container cont">
		...
		<!-- <div class="container">
			<div class="row justify-content-center">
				<div class="col-md-10">
					<nav id="tours-nav" class="nav nav-pills nav-justified nav-tours">
						<a class="nav-item nav-link" href="#halfday">Half Day Tours</a>
						<a class="nav-item nav-link" href="#fullday">Full Day Tours </a>
						<a class="nav-item nav-link" href="#multipledays">Multiple Day Tours </a>
					</nav>
				</div>
			</div>
		</div>
		<section id="halfday" class="container cont">
			<div class="row">
				<div class="col-sm-12 text-center">
					<h1 class="tours-heading"><i>Half Day Tours</i></h1>
				</div>


			</div>
		</section>
		<section id="fullday" class="container cont">
			<div class="row">
				<div class="col-sm-12 text-center">
					<h1 class="tours-heading"><i>Full Day Tours</i></h1>
				</div>

			</div>
		</section>
		<section id="multipledays" class="container cont">
			<div class="row">
				<div class="col-sm-12 text-center">
					<h1 class="tours-heading"><i>Multiple Day Tours</i></h1>
				</div>
